...
print(solutionKN,'\n -----')
solutionTD2 = bw.computeCircuitUsingTensorDot(psiReshaped,[(UReshaped[0],0,1),(UReshaped[1],2,3),(UReshaped[2],1,2),(UReshaped[3],0,1),(UReshaped[4],2,3),(UReshaped[5],1,2)]).flatten()
print(solutionTD2, '\n -----') 
